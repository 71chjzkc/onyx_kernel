...
#if defined(CONFIG_ZRAM_WRITEBACK)
static u64
mem_cgroup_anno_writeback_control_read(struct cgroup_subsys_state *css,
				      struct cftype *cft)
{
...
static int
mem_cgroup_anno_writeback_control_write(struct cgroup_subsys_state *css,
...
static struct cftype memsw_writeback_control_files[] = {
	{
		.name = "anno_writeback_control",
		.read_u64 = mem_cgroup_anno_writeback_control_read,
		.write_u64 = mem_cgroup_anno_writeback_control_write,
	},
	{}, /* terminate */
};
#endif
...
#if defined(CONFIG_ZRAM_WRITEBACK)
	WARN_ON(cgroup_add_legacy_cftypes(&memory_cgrp_subsys, memsw_writeback_control_files));
#endif
